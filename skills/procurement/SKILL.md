...
2. **PIVOT NGAY KHI THẤY MÃ:** bất kỳ title/trang nào lộ SKU/MPN/GTIN → thêm vào ledger. Với tối đa 3–5 ứng viên đầu bảng theo mục tiêu max/min, chạy helper deterministic bằng entry point đang dùng:
   ```bash

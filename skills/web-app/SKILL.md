...
the whole flow. Either way: **commit to an aesthetic direction first** (`../hackathon-engine/references/design-engine.md` Law 0 — honor the
user's house style if they have one) and **ship a complete SEO `<head>`** on any public page (`../hackathon-engine/references/seo.md`).
...
3. **Design system.** Read `../hackathon-engine/references/design-engine.md` (+ `../hackathon-engine/references/motion.md`). **Commit to ONE
...
7. **Ship & observe.** `docker` skill + `../hackathon-engine/references/devops.md` - containerize,
   ...
   For ANY public page, ship the complete SEO `<head>` from `../hackathon-engine/references/seo.md` (title/description, canonical,

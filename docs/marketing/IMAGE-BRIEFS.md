...
- headline, one line — EN: **It runs on your computer. Coding tools run free — destructive still asks.**
- the same card in Vietnamese as `og-vi.png` — **Nó chạy trên máy bạn. Coding chạy tự do — destructive vẫn hỏi.**

...
test("Neko and Codex auth/control stores stay hidden across every safe filesystem surface", async () => {
  ...
  const hidden = [
    ...
    ".neko-core/grok-auth.json",
    ".neko-core/kimi-auth.json.tmp-1",
    ".neko-core/opencode-auth.json",
    ".neko-core/cline-auth.json",
...
test("the deny list names what it is protecting", () => {
  const cases: Array<[string, string]> = [
    ...
    ["C:/Users/Admin/.neko-core/grok-auth.json", "Neko authentication credentials"],
    ["C:/Users/Admin/.neko-core/kimi-auth.json", "Neko authentication credentials"],
    ["C:/Users/Admin/.neko-core/opencode-auth.json", "Neko authentication credentials"],
    ["C:/Users/Admin/.neko-core/cline-auth.json", "Neko authentication credentials"],

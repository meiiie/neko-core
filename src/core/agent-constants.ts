...
export const DEFAULT_SYSTEM_PROMPT =
  ...
  "- Treat later messages as additions unless they clearly replace unfinished work. Never resurrect an unrelated older task after replacement; resume only when asked.\n" +

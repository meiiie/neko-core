...
export const CREDENTIAL_READ_DENY_GLOBS = [
  ...
  ...fileWithWriteVariants("**/.neko-core/chatgpt-auth.json"), ...fileWithWriteVariants("**/.neko-core/grok-auth.json"),
  ...fileWithWriteVariants("**/.neko-core/kimi-auth.json"), ...fileWithWriteVariants("**/.neko-core/opencode-auth.json"),
  ...fileWithWriteVariants("**/.neko-core/cline-auth.json"),
...
const CREDENTIAL_PATHS: Array<[RegExp, string]> = [
  ...
  [/(^|[\\/])\.neko-core[\\/](chatgpt-auth|grok-auth|kimi-auth|opencode-auth|cline-auth)\.json(?:[.-][^\\/]*)?$/i, "Neko authentication credentials"],

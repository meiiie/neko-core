...
export const TOOL_SPECS: ToolSpec[] = [
  ...
  },
  {
    ...
    parameters: {
      ...
      mark: { type: "number", description: "Set-of-Marks target for click: a [N] number from the most recent `ocr`. PREFERRED over x,y for Chromium/Electron apps - the resident host resolves the mark to coordinates, so you never reproduce pixels (the reliable path for text-only models)." },
